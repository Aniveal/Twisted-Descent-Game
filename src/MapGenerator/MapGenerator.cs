...
public class MapGenerator {
    ...
    private void createPrototypeLists() {
        ...
        CliffPrototypes.Add(new Prototype(_cliffTextures[1], null, "Cliff_1ul", new[] { 7, 8, 6, 8 }, 2000, false, true));
        CliffPrototypes.Add(new Prototype(_cliffTextures[2], null, "Cliff_1dl", new[] { 8, 7, 7, 8 }, 2000, false, true));
